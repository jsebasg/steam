...
import perficient.steam.exceptions.UnauthorizedException;
...
import static perficient.steam.domain.Constants.COOKIE_NAME;
            ...
            try
            {
                ...
                if ( token != null )
                {
                    ...
                    if (roles == null) {
                        ...
                        SecurityContextHolder.getContext().setAuthentication( new TokenAuthentication( token, subject, roles.get(0)));
                    }
